...
async function main() {
  ...
  const settings = [
    { key: 'store_name', value: 'Smoocho Dessert Shop', data_type: DataType.STRING, description: 'Name of the store' },
    { key: 'tax_rate', value: '0.05', data_type: DataType.NUMBER, description: 'Tax rate (5%)' },
    { key: 'currency', value: 'INR', data_type: DataType.STRING, description: 'Currency code' },
    { key: 'currency_symbol', value: '₹', data_type: DataType.STRING, description: 'Currency symbol' },
    { key: 'auto_print_receipt', value: 'true', data_type: DataType.BOOLEAN, description: 'Auto print receipt after payment' },
    { key: 'low_stock_alert_enabled', value: 'true', data_type: DataType.BOOLEAN, description: 'Enable low stock alerts' },
    { key: 'sync_interval_minutes', value: '5', data_type: DataType.NUMBER, description: 'Sync interval in minutes' },
  ];
